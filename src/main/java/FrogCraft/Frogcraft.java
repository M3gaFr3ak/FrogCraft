...
import FrogCraft.Integration.GregTech;
import FrogCraft.Integration.ic2;
...
public class Frogcraft
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		fcItems.tabFrogCraft = new CreativeTabs("tabFrogCraft")
		{
			...
			{
				return new ItemStack(fcItems.Machines, 1, 8);
			}
		};
	...
	public void regItems()
	{
		...
		// Register MetaBlocks
		GameRegistry.registerBlock(fcItems.Machines, ItemBlockMachines.class, "machines1");
		GameRegistry.registerBlock(fcItems.Machines2, ItemBlockMachines2.class, "machines2");
		GameRegistry.registerBlock(fcItems.Ore, FrogCraft.Blocks.ItemBlockOre.class, "ores");

		// Register Normal Blocks
		GameRegistry.registerBlock(fcItems.BlockHNO3, "nitricAcid");
		GameRegistry.registerBlock(fcItems.ACWindMillCylinder, "windMill");
		GameRegistry.registerBlock(fcItems.MobilePS, ItemBlock_MobilePS.class, "powerStation");
