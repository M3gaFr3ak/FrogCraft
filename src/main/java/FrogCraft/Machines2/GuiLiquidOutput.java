...
public class GuiLiquidOutput extends GuiLiquids {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    	...
    	mc.renderEngine.bindTexture(new ResourceLocation("frogcraft:textures/gui/Gui_LiquidInjector.png"));
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,int par3) {
		...
		mc.renderEngine.bindTexture(new ResourceLocation("frogcraft:textures/gui/Gui_LiquidOutput.png"));
		int x = (width - xSize) / 2;
