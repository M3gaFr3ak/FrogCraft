...
public class GuiLiquifier extends GuiLiquids {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    	...
    	mc.renderEngine.bindTexture(new ResourceLocation("frogcraf:textures/gui/Gui_Liquifier.png"));
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2,int par3) {
		...
		mc.renderEngine.bindTexture(new ResourceLocation("frogcraft:textures/gui/Gui_Liquifier.png"));
		int x = (width - xSize) / 2;
