...
public class BlockMachines extends BlockContainer
{
	...
	public void registerIcons(IconRegister r)
	{
		...
		for (String fluidName : FluidManager.fluids.keySet())
			net.minecraftforge.fluids.FluidRegistry.getFluid(fluidName.toLowerCase()).setIcons(r.registerIcon("FrogCraft:Fluids/" + fluidName));
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		if (entityPlayer.getCurrentEquippedItem() != null && (entityPlayer.getCurrentEquippedItem().getUnlocalizedName().toLowerCase().contains("wrench")))
		{
