...
public class DamageSource_Coin extends EntityDamageSourceIndirect
{
	...
	public DamageSource_Coin(String par1Str, Entity par2Entity, Entity par3Entity)
	{
	...
	{
		return new ChatMessageComponent().addText(((EntityPlayer) getEntity()).username + " Railguned " + ((EntityPlayer) player).username);
	}
}
