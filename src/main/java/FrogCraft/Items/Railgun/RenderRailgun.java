...
public class RenderRailgun implements IItemRenderer
{
	...
	void renderShadow()
	{
		...
		mc.renderEngine.bindTexture(new ResourceLocation(("textures/entity/creeper/creeper_armor.png")));
	...
	{
		Tessellator tessellator = Tessellator.instance;
		mc.renderEngine.bindTexture(new ResourceLocation("frogcraft:textures/render/Coin.png"));
		GL11.glPushMatrix();
